      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl shadow-primary/10">
              <Image
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -right-4 md:right-8 bg-background border border-border rounded-xl p-6 shadow-xl max-w-[240px]"
            >
