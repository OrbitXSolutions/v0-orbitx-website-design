    ...
    <section id="process" className="py-24 md:py-32 bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-background mt-4 mb-6 text-balance">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-background/5 border border-background/10 group hover:bg-background/10 transition-all duration-300"
            >
              <div className="absolute top-8 right-8 text-6xl font-bold text-background/5 group-hover:text-background/10 transition-colors">
                {step.number}
              </div>

              <div className="relative z-10">
                <div className="w-14 h-14 rounded-xl bg-background/10 flex items-center justify-center mb-6 group-hover:bg-background/20 transition-colors">
