...
const projects = [
  {
    ...
    description: "Connects pet owners with veterinary services through a clean and accessible digital experience.",
    image: "/images/projects/zoolker.jpg",
  },
  {
    name: "Gold Checker",
    category: "Gold Verification Platform",
    description: "A trusted platform for gold checking services with a simple and professional interface.",
    image: "/images/projects/gold-checker.jpg",
  },
  {
    name: "MKL Fitout",
    category: "Interior & Fitout Website",
    description: "Corporate website showcasing fitout services and business capabilities.",
    image: "/images/projects/mkl-fitout.jpg",
  },
  {
    name: "Amr Fitness",
    category: "Fitness Website",
    description: "A modern platform presenting training programs and coaching services.",
    image: "/images/projects/amr-fitness.jpg",
  },
  {
    name: "Honna La Honna",
    category: "Community Platform",
    description: "A structured and elegant digital platform focused on community engagement.",
    image: "/images/projects/honna.jpg",
  },
  {
    name: "Rawad Al Tameer",
    category: "Construction Website",
    description: "Professional site presenting construction services and company expertise.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Explore our latest work delivering digital solutions for businesses across the UAE.
          </p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="inline-flex items-center gap-2 text-sm font-medium text-foreground hover:text-accent transition-colors">
                  Visit Website
