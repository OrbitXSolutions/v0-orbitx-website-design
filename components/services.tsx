...
import { Code2, Building2, Brain, ShoppingCart, Globe, Lightbulb } from "lucide-react";

const services = [
  {
    icon: Code2,
    title: "Custom Web Development",
    description: "Build high-performance, scalable web applications tailored to business needs.",
    features: ["Custom architecture (no templates)", "Secure & scalable systems", "Next.js & .NET solutions"],
  },
  {
    icon: Building2,
    title: "Enterprise Systems Development",
    description: "Design and build complex systems for organizations and government entities.",
    features: ["Workflow automation", "Role-based architecture", "High scalability"],
  },
  {
    icon: Brain,
    title: "AI-Powered Solutions",
    description: "Integrate AI into business workflows for smarter operations.",
    features: ["AI automation", "Smart analytics", "Intelligent systems"],
  },
  {
    icon: ShoppingCart,
    title: "E-commerce Development",
    description: "Build modern online stores with conversion-focused design.",
  ...
  },
  {
    ...
    description: "Help businesses move into digital systems and optimize processes.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            We deliver custom software solutions that drive business growth and digital transformation.
          </p>
        </motion.div>
