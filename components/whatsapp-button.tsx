  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="hidden md:block opacity-0 group-hover:opacity-100 transition-all duration-300 bg-foreground text-background px-4 py-2 rounded-full text-sm font-medium shadow-lg translate-x-4 group-hover:translate-x-0">
          Chat with us
        </span>
