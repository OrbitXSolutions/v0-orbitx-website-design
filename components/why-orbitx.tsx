...
export function WhyOrbitX() {
  return (
    <section id="why-orbitx" className="py-24 md:py-32 relative bg-background">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-muted/50 border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300"
              >
